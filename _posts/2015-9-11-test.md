...
:   This definition has sub definition list
...
public class NotificationSetting {
    private static final String FILE_SUFFIX = "_ns";
    public static final int NO_DISTURB_TIME_START = 22;
    private Context context;
    private NoticationSettingValue curNoticationSettingValue;

    private class NoticationSettingValue {
        public static final String RECEIVE_NOTIFICATION = "receive_notification";

        public void reset() {
            bReceiveNotification = true;
            bNoNotificationDetailInfo = false;
            bExistSound = true;
            bExistVibrate = false;
            bNoDiturbMode = false;
            sNotifyAfterExit = "ask";
        }
    }

    // hello java
    private NotificationSetting(Context context) {
        this.context = context;
        this.curNoticationSettingValue = new NoticationSettingValue();
    }

    public synchronized static NotificationSetting getInstance(Context context) {
        if (sNotificationSetting == null) {
            sNotificationSetting = new NotificationSetting(context);
        }
